 ...
 * @property searchQuery The current search query applied to the collection.
...
sealed class MyCollectionScreenState(
    ...
    ) : MyCollectionScreenState(entries, filter, searchQuery, hasMore, false, error)
    ...
    ) : MyCollectionScreenState(entries, filter, searchQuery, hasMore, isLoadingMore)
}
